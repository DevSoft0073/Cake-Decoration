//
//  OrderListingModal.swift
//  CakeDecoration
//
//  Created by MyMac on 10/08/21.
//
// This file was generated from JSON Schema using quicktype, do not modify it directly.
// To parse the JSON, add this file to your project and do:
//
//   let orderListingModal = try OrderListingModal(json)
...
// MARK: OrderListingModal convenience initializers and mutators

extension OrderListingModal {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(OrderListingModal.self, from: data)
    }
